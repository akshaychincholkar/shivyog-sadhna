...
const CardNavigator = () => {
  ...
  const handleTabChange = (event, newValue) => {
    ...
    setActiveCardIndex(0); // Reset card index when switching tabs
  };

  const handleNextCard = () => setActiveCardIndex((prev) => prev + 1);
  const handlePreviousCard = () => setActiveCardIndex((prev) => prev - 1);
const tabData = [
  {
    id: 1,
...
// import { Box, Tabs, Tab, Card, CardContent, Typography, Button, Stack,useMediaQuery } from "@mui/material";

// const AlternateTab = styled(Tab)(({ theme, index }) => ({
...
//         variant="scrollable"
//         scrollButtons="auto"
//         aria-label="alternate tabs example"
//         sx={{
